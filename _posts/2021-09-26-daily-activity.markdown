...
| 02-09-2021 | Mengerjakan challenge 2 blocker sudah bisa solved mengenai challenge 2. Melihat dokumentasi vue, mencoba wpm nilai 51 wpm. Hackerrank baru nyoba 1 soal. | masih sulit memahami logika | - | [Challenge Day 2](https://github.com/Miraluthfi/Challenge-Day2) |
...
| 10-09-2021 | Rest API get dan POST. Wpm dengan nilai 60 | - |
 | - |
| 13-09-2021 | Untuk progress yang kemarin mengenai axioo cdn. Wpm 57-60. Hackerrank belum lanjut. | Install axio cli error | Setelah berdiskusi bersama teman, ternyata bukan error. | - |